...
public class ConfigurationHandler {
	...
	public static void handleConfig(File file) {
		...
		try {
			...
			BlockIDs.BLOCK_DECORATIVE_SLAB_ID = config.getBlock(Strings.BLOCK_DECORATIVE_SLAB, BlockIDs.BLOCK_DECORATIVE_DEFAULT_ID).getInt(BlockIDs.BLOCK_DECORATIVE_DEFAULT_ID);
