package electrodynamics.core.configuration;
...
public class ConfigurationHandler {
	...
	public static void handleConfig(File file) {
		...
		try {
			...
			ElectroDynamicsCore.proxy.setKeyBinding(ConfigurationSettings.HOVER_MODE_TOGGLE_NAME, config.get(CATEGORY_KEYS, ConfigurationSettings.HOVER_MODE_TOGGLE_CONFIGNAME, ConfigurationSettings.HOVER_MODE_TOGGLE_DEFAULT).getInt(ConfigurationSettings.HOVER_MODE_TOGGLE_DEFAULT), false);
