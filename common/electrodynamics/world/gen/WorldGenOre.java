...
public class WorldGenOre extends WorldGenerator {
    ...
    public WorldGenOre(ItemStack ore, int clusterSize) {
    ...
    public WorldGenOre(WeightedRandomBlock resource, int clusterSize) {
    ...
    public WorldGenOre(List<WeightedRandomBlock> resource, int clusterSize) {

        cluster = resource;
        genClusterSize = clusterSize;
    }

    public WorldGenOre(ItemStack ore, int clusterSize, int blockID) {
    ...
    public WorldGenOre(WeightedRandomBlock resource, int clusterSize, int blockID) {
    ...
    public WorldGenOre(List<WeightedRandomBlock> resource, int clusterSize, int blockID) {
