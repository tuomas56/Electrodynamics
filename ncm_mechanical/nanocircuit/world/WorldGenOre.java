...
public class WorldGenOre implements IWorldGenerator {
	...
	public WorldGenOre() {
		magnetiteGen = new WorldGenMinable( NanoCircuitWorld.blockOre.blockID, Reference.ORE_META.MAGNETITE, 8 );
		nickelGen = new WorldGenMinable( NanoCircuitWorld.blockOre.blockID, Reference.ORE_META.NICKEL, 8 );
	}
